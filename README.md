...
|:------|:------|:----------|
| **ECMDB** | 提供平台底层处理架构，涵盖自定义资产模型重算、内部审批引擎与整体资源 API 调度服务。 | [ecmdb](https://github.com/userreksai/ecmdb-main) |
| **ECMDB-WEB** | 基于 Vue 3 构建的交互操作层，负责将动态表单与可拖拽审批流程图等可视化投射给终端用户。 | [ecmdb-web](https://github.com/userreksai/ecmdb-web) |
...
| **ENotify** | 系统侧全量外围消息的收口分发服务，集中化桥接包括飞书、邮件等下发媒介的最终投递网关。 | [enotify](https://github.com/userreksai/enotify) |
