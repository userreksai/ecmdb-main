			...
			workflow: Workflow{
				...
				FlowData: LogicFlow{
					Nodes: []map[string]interface{}{
						...
						{"id": "b4845f3c-43f6-4040-81f8-5f96309c0490", "type": "automation", "properties": map[string]interface{}{"name": "自动化-部署", "codebook_uid": "deploy", "tag": "default", "is_notify": false}},
