...
func (m *MockService) SearchResourcesInModel(ctx context.Context, fields []string, modelUid string, conditions []domain.SearchCondition, offset, limit int64) ([]domain.Resource, int64, error) {
	m.ctrl.T.Helper()
...
func (mr *MockServiceMockRecorder) SearchResourcesInModel(ctx, fields, modelUid, conditions, offset, limit any) *MockServiceSearchResourcesInModelCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SearchResourcesInModel", reflect.TypeOf((*MockService)(nil).SearchResourcesInModel), ctx, fields, modelUid, conditions, offset, limit)
	return &MockServiceSearchResourcesInModelCall{Call: call}
}

// MockServiceSearchResourcesInModelCall wrap *gomock.Call
type MockServiceSearchResourcesInModelCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockServiceSearchResourcesInModelCall) Return(arg0 []domain.Resource, arg1 int64, arg2 error) *MockServiceSearchResourcesInModelCall {
	c.Call = c.Call.Return(arg0, arg1, arg2)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockServiceSearchResourcesInModelCall) Do(f func(context.Context, []string, string, []domain.SearchCondition, int64, int64) ([]domain.Resource, int64, error)) *MockServiceSearchResourcesInModelCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockServiceSearchResourcesInModelCall) DoAndReturn(f func(context.Context, []string, string, []domain.SearchCondition, int64, int64) ([]domain.Resource, int64, error)) *MockServiceSearchResourcesInModelCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
