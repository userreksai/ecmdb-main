...
import (
	...
	domain "github.com/userreksai/ecmdb-main/internal/resource/internal/domain"
...
func (m *MockEncryptedSvc) SearchResourcesInModel(ctx context.Context, fields []string, modelUid string, conditions []domain.SearchCondition, offset, limit int64) ([]domain.Resource, int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SearchResourcesInModel", ctx, fields, modelUid, conditions, offset, limit)
	ret0, _ := ret[0].([]domain.Resource)
	ret1, _ := ret[1].(int64)
	ret2, _ := ret[2].(error)
	return ret0, ret1, ret2
...
func (mr *MockEncryptedSvcMockRecorder) SearchResourcesInModel(ctx, fields, modelUid, conditions, offset, limit any) *MockEncryptedSvcSearchResourcesInModelCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SearchResourcesInModel", reflect.TypeOf((*MockEncryptedSvc)(nil).SearchResourcesInModel), ctx, fields, modelUid, conditions, offset, limit)
	return &MockEncryptedSvcSearchResourcesInModelCall{Call: call}
}

// MockEncryptedSvcSearchResourcesInModelCall wrap *gomock.Call
type MockEncryptedSvcSearchResourcesInModelCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockEncryptedSvcSearchResourcesInModelCall) Return(arg0 []domain.Resource, arg1 int64, arg2 error) *MockEncryptedSvcSearchResourcesInModelCall {
	c.Call = c.Call.Return(arg0, arg1, arg2)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockEncryptedSvcSearchResourcesInModelCall) Do(f func(context.Context, []string, string, []domain.SearchCondition, int64, int64) ([]domain.Resource, int64, error)) *MockEncryptedSvcSearchResourcesInModelCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockEncryptedSvcSearchResourcesInModelCall) DoAndReturn(f func(context.Context, []string, string, []domain.SearchCondition, int64, int64) ([]domain.Resource, int64, error)) *MockEncryptedSvcSearchResourcesInModelCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
