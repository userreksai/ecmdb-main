...
func (m *MockResourceRepository) SearchResourcesInModel(ctx context.Context, fields []string, modelUid string, conditions []domain.SearchCondition, offset, limit int64) ([]domain.Resource, int64, error) {
	m.ctrl.T.Helper()
...
func (mr *MockResourceRepositoryMockRecorder) SearchResourcesInModel(ctx, fields, modelUid, conditions, offset, limit any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SearchResourcesInModel", reflect.TypeOf((*MockResourceRepository)(nil).SearchResourcesInModel), ctx, fields, modelUid, conditions, offset, limit)
}
